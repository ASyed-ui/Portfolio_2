    ...
    >
      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <div className="flex items-center justify-between">
                ...
                {/* Toggle link to show/hide Education form */}
                <button
                  type="button"
                  onClick={() => setShowEducationForm((s) => !s)}
                  className="ml-4 border border-blue-500/50 text-blue-500 py-1 px-3 rounded text-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_10px_rgba(59,130,246,0.12)] hover:bg-blue-500/10"
                >
          ...
          {/* Render the EducationForm inline under the About content when toggled */}
          {showEducationForm && (
            <div className="mt-8">
              <EducationForm />
            </div>
